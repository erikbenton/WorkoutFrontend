...
* Local Storage and how storing the app state there can help prevent the app state reseting when the browser refreshes.
* UI/UX: How a good UI/UX can go a long way towards a User's enjoyment of an app, especially considering mobile screens. 
  ...
  - Using Modals and not relying on browser confirm() or alert() functionality to interact with the lifter.
